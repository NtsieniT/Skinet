...
export class BasketService {
  ...
  // Behaviour subject is an observable which will emit a value
  ...
  // helper method to return whatever is contained in the basket source
  ...
  addItemToBasket(item: IProduct, quantity = 1){
    ...
    // map properties from product to basket item
  ...
  // this helper method adds or updates items
  ...
  private createBasket(): IBasket {
    ...
    // store basket id in localstorage
